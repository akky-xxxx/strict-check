...
import type { MessageId, Option } from "../../../../src/rules/restrict-use-of-process-env/types"

tester.run<MessageId, Option[]>("restrict-use-of-process-env", restrictUseOfProcessEnv, {
  valid: [
    {
