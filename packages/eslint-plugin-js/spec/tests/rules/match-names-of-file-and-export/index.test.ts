...
import type { MessageId, Option } from "../../../../src/rules/match-names-of-file-and-export/types"

const options: Option[] = [
  {
    captures: ["/(.+)/index.tsx", /(.+)\/index.tsx/],
  },
]

tester.run<MessageId, Option[]>("match-names-of-file-and-export", matchNamesOfFileAndExport, {
  valid: [
    {
